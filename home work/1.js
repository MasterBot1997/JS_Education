...
const temperCel = +(prompt("Введите температуру по Цельсия"));
tempForengate(temperCel)

function tempForengate(num) {
    temperFor = (9/5)*num+32;
    // Без округления
    // return alert(`Цельсий: ${num}, Фаренгейт: Фаренгейт: ${temperFor}`);

    // С округлением
    return alert(`Цельсий: ${num}, Фаренгейт: ${temperFor.toFixed(2)}`);
}
